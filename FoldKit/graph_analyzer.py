...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""Examples:
  python graph_analyzer.py model_01.pdb
  python graph_analyzer.py dir/
  python graph_analyzer.py *.pdb -o results.txt
  python graph_analyzer.py *.pdb --set set_a,set_b -o by_set.txt
  python graph_analyzer.py *.pdb --sets set_a set_b set_c -o "output_{}.txt"
  python graph_analyzer.py *.pdb --per-structure -o "{}_graph.txt"
  python graph_analyzer.py *.pdb --sets set_a set_b -o results.txt --dry-run
""",
    )

...
""",
    ...
    summary_log = setup_log_from_args(args, script_path=__file__, inputs=list(getattr(args, "input", []) or []), pattern=None)
    if summary_log is not None:
        summary_log.task("Packing metrics (packing_metrics.py)")
